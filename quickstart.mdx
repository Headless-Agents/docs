...
<AccordionGroup>
  <Accordion icon="key" title="Create an account">
    Sign up for a Headless Agents account at [dashboard.headlessagents.ai](https://dashboard.headlessagents.ai).
    Once registered, you'll be able to access your dashboard and create API keys.
  </Accordion>
